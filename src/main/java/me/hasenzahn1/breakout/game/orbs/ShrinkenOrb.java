...
public class ShrinkenOrb extends Orb{

    private static final BufferedImage IMAGE = ImageLoader.loadImage("game/orbs/orb_shrinken.png");

    public ShrinkenOrb(int x, int y) {
        super(x, y, IMAGE);
    }
